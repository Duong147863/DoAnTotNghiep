...
class InfoWorkingprocessesEmloyeeScreen extends StatefulWidget {
  final WorkingProcesses? workingProcesses;
  const InfoWorkingprocessesEmloyeeScreen({super.key, this.workingProcesses});

  @override
  State<InfoWorkingprocessesEmloyeeScreen> createState() =>
      _InfoWorkingprocessesEmloyeeScreenState();
}

class _InfoWorkingprocessesEmloyeeScreenState
    extends State<InfoWorkingprocessesEmloyeeScreen> {
  ...
  Widget build(BuildContext context) {
    return BasePage(
      showAppBar: true,
      titletext: 'Info Workingproces Screen',
