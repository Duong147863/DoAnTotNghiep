...
class ListTrainingprocessesEmloyeeScreen extends StatefulWidget {
  final Profiles? profiles;
  const ListTrainingprocessesEmloyeeScreen({super.key,this.profiles});

  @override
  State<ListTrainingprocessesEmloyeeScreen> createState() => _ListTrainingprocessesEmloyeeScreenState();
}

class _ListTrainingprocessesEmloyeeScreenState extends State<ListTrainingprocessesEmloyeeScreen> {
                  ...
                  return CustomCard(
                    ...
                    () async {
                      ...
                      final updatedWorkingProcesses = await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => InfoTrainingprocessesEmloyeeScreen(
