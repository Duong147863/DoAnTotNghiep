...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BasePage(
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute<void>(
                      builder: (BuildContext context) =>
                          ListWorkingprocessEmloyeeScreen(
                              profiles: widget.profile),
                    ),
                  );
                },
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute<void>(
                      builder: (BuildContext context) =>
                          ListWorkingprocessHRScreen(profiles: widget.profile),
                    ),
                  );
                },
              ),
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute<void>(
                      builder: (BuildContext context) =>
                          ListTrainingprocessesEmloyeeScreen(
                        profiles: widget.profile,
                      ),
                    ),
                  );
                    ...
                    children: [
                      Consumer<DeparmentsViewModel>(
                        ...
                        if (!viewModel.fetchingData &&
                          ...
                          Provider.of<DeparmentsViewModel>(context,
                                  listen: false)
                              .fetchAllDepartments();
                        }
                        if (viewModel.fetchingData) {
        ...
        fab: AppStrings.ROLE_PERMISSIONS
            ...
            : (AppStrings.ROLE_PERMISSIONS.contains('Manage Staffs info only'))
                ? SpeedDial(
                    elevation: 0,
                    icon: Icons.menu,
                    buttonSize: Size(50, 50),
